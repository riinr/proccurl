...
when isMainModule:
  ...
  proc main(): void =
    ...
    This version, doesn't use any asynch/thread feature, just function call via dynamic dispatch (procedure variable).
